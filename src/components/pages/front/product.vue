    ...
    <transition-group tag="div" name="list" class="row mt-3 no-gutters">
        ...
        <div class="col-6 col-md-4 mb-3 d-flex justify-content-center"
            ...
            <div class="card" style="width:100%">
                <div class="card-img-top bg-contain" 
                    style="min-height:300px"
                    :style="{backgroundImage:`url(${product.imageUrl})`}">
                </div>
                <div class="card-body">
                    <div class="text-center">
                        <router-link :to="{name:'detail',params:{id: product.id }}" tag="a" class="card-title mb-0 font-weight-bolder">
                            {{product.title}}
                        ...
                        <small class="d-block"><router-link :to="{name:'detail',params:{id: product.id }}">查看詳情</router-link></small>
                        <small class="d-block">
