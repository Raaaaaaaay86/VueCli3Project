                ...
                <tr v-for="product in products" :key="product.id">
                    ...
                    <td class="d-flex">
                        <button class="btn btn-sm btn-secondary mr-1"
                                @click.prevent="openModal(product,false,'detailModal')">編輯</button>
    ...
    <!--DELETE MODAL-->
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <p>確定要刪除 商品: <span class="text-danger font-weight-bolder">{{tempProduct.title}}</span> 嗎?</p>
...
export default {
    ...
    methods:{
        ...
        updateProduct(){
            ...
            vm.$http[method](api,{data: vm.tempProduct})
            .then(response =>{
