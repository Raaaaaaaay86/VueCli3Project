<template>
    ...
    <!--ADD BTN-->
        ...
        <button class="btn bnt-lg btn-secondary my-3"
                ...
                <div class="modal-header">
                    ...
                    <validation-observer v-slot="{ handleSubmit }">
                        <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="couponDueDate">到期日 <span class="text-danger" v-if="tempCoupon.due_date">{{tempCoupon.due_date | timeStamp}}</span></label>
    ...
    <!--DELETE MODAL-->
        <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <p>確定要刪除 優惠券: <span class="text-danger font-weight-bolder">{{tempCoupon.title}}</span> 嗎?</p>
    ...
    methods:{
        ...
        openModal(coupon,isNew,modalId){
            ...
            if(isNew){
                ...
                vm.isNew = false;
                vm.tempCoupon = Object.assign({},coupon);;
                $(`#${modalId}`).modal('show');
            }
        },
        updateCoupon(isNew){
            ...
            let method;
            let api;
            let date = vm.tempCoupon.due_date;
            ...
            vm.$http[method](api,{data: vm.tempCoupon})
            .then(response =>{
